...
// 6.1 USD/BRL — média anual
export const USD_BRL = {
  2016: 3.49, 2017: 3.19, 2018: 3.65, 2019: 3.94, 2020: 5.16,
  2021: 5.39, 2022: 5.16, 2023: 4.99, 2024: 5.39, 2025: 5.58,
};
...
// 6.5 S&P 500 anual em USD
export const SP500 = {
  2016: 0.1196, 2017: 0.2183, 2018: -0.0438, 2019: 0.3149, 2020: 0.1840,
  2021: 0.2871, 2022: -0.1811, 2023: 0.2629, 2024: 0.2502, 2025: 0.1000,
};

// 6.6 NASDAQ 100 anual em USD
export const NASDAQ = {
  2016: 0.0710, 2017: 0.3270, 2018: -0.0010, 2019: 0.3900, 2020: 0.4860,
  2021: 0.2740, 2022: -0.3260, 2023: 0.5642, 2024: 0.2572, 2025: 0.1945,
};

// 6.7 FipeZap residencial anual em BRL
...
// 6.8 Ibovespa anual em BRL
export const IBOV = {
  2016: 0.3893, 2017: 0.2686, 2018: 0.1503, 2019: 0.3158, 2020: 0.0292,
  2021: -0.1193, 2022: 0.0469, 2023: 0.2228, 2024: -0.1036, 2025: 0.0650,
};
...
// 7.5 Renda Fixa BR ponderada — rentabilidades anuais
...
// CAGRs históricos médios por classe — seção 8 e 11.3
export const ASSET_CLASS_RETURNS = {
  rfBR:        0.093, // CDI 10y
  rvBR:        0.118, // Ibov 10y BRL
  imoveis:     0.038, // FipeZap 10y BRL
  dolarizado:  0.135, // S&P em BRL
  outros:      0.060,
};
...
export const COMPARISON_CARDS = [
  ...
  { id: 'imovel', nome: 'Imóvel (FipeZap)',     icone: 'Building2',  usd: -0.011, accum10y: -0.105, vol: 0.120 },
  { id: 'dolar',  nome: 'Dólar puro',           icone: 'DollarSign', usd: 0.000, accum10y: 0.000, vol: 0.000 },
  { id: 'sp500',  nome: 'S&P 500',              icone: 'LineChart',  usd: 0.135, accum10y: 2.541, vol: 0.165 },
  { id: 'nasdaq', nome: 'NASDAQ 100',           icone: 'Cpu',        usd: 0.195, accum10y: 4.943, vol: 0.245 },
  { id: 'mag7',   nome: 'Magnificent 7',        icone: 'Rocket',     usd: 0.320, accum10y: 15.952, vol: 0.350 },
];

// 11.3 Carteira institucional padrão
export const INSTITUTIONAL_PORTFOLIO_RETURN = 0.137; // 13,7% a.a. BRL
export const INSTITUTIONAL_BREAKDOWN = [
  { classe: 'S&P 500',               peso: 0.40, retorno: 0.135 },
  { classe: 'NASDAQ 100',            peso: 0.30, retorno: 0.195 },
